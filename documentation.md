...
> **Est-il possible de déployer l'application sur un autre environnement (un autre système, dans le cloud, sur un autre OS, etc.) ?**

Une application portable permet de faire évoluer son environnement plus facilement et évite les dépendances techniques implicites.
...
> **Une date de fin de support ou de fin de vie a-t-elle été publiée ?**

Si une date de fin existe, même officieusement, cela veut dire que la solution est obsolète et un remplacement doit être envisagé
...
- Complexité technique en regard de la complexité fonctionnelle
...
> **L’interface utilisateur, et l'expérience utilisateur associée, sont-elle modernes et à jour ?**

Une interface viellote ou mal adaptée aux besoins actuels limitera le bon usage de l'application.

Une interface peu appréciée est le premier élément incitant les utilisateurs à demander un changement d'application.
